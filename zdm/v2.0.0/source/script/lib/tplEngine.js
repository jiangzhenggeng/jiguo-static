...
define(['require','jquery'],function (require,$){
    ...
    return {
        newTplEngine: function (tpl, data) {
            tpl = tpl.toString();
            if(tpl=='') return data?'':function () {};
            ...
            tpl.replace(_RegExp, function (match_all, match_target, index, resource) {
                ...
                if (match_target.substr(0, 1) == '=') {
                    ...
                    //如果是变量并且转意
                    function_body += 'r.push(typeof(' + _match_target.substr(3) + ') === "undefined"?"":this._encodeHTML(' + _match_target.substr(3) + '));\n';
