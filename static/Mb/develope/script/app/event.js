 ...
 */
define(['jquery', 'index', 'app/login', 'layer', 'app/tplEngine', 'app/countdown', 'app/videoAdapt', 'app/lazyload','app/function'], function ($, index, login, layer, tplEngine, countdown, videoAdapt,lazyload,fc) {
