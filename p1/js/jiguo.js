...
(function($,window){
  $.fn.focusbanner = function(options){
    return this.each(function(){
      var o = $.extend(
            {},
            $.fn.focusbanner.options, options || {}
            ), 
          loopBody = $(o.loopBody),
...
(function(){
  ...
  // 首页焦点图
  $('.focuslist').find('ul').eq(0).addClass('on');
  $('.slideBox').focusbanner({
    loopBody: '.focuslist',
    curClass: 'on',
    speed: 500,
    gap: 3000,
  ...
  // 产品页焦点图
  $('.topic-swipe').find('li').eq(0).addClass('on');
  $('.focus .bd').focusbanner({
    loopBody: '.topic-swipe',
    curClass: 'on',
    speed: 500,
    gap: 3000,
    next: '.focus-btn-next',
  ...
  $('.loginUser .avt').on('mouseover', function(e) {
    e.preventDefault();
    $('.loginUser .userList').removeClass('noDis');
  });

  $('.loginUser .avt').on('mouseout', function(e) {
    e.preventDefault();
    $('.loginUser .userList').addClass('noDis');
  });

  $('.userList').on('mouseover', function(e) {
    e.preventDefault();
    $('.loginUser .userList').removeClass('noDis');
  });
  $('.userList').on('mouseout', function(e) {
    e.preventDefault();
    $('.loginUser .userList').addClass('noDis');
  });
