$(function () {
    ...
    $('head').append('<style>.header{height:' + windowHeight + 'px;width:100%;position: relative;color:#fff;background-image: url(http://cdn.jiguo.com/zdx/park/2017/img/bg.jpg);background-repeat: no-repeat;background-size: 100% 100%}</style>');
